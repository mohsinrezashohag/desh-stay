...
const ApartmentDetails = () => {
    ...
    const { id } = params
    const { data: propertyDetails, isLoading, isError } = useGetPropertyDetailsQuery(id)
    ...
    if (!isLoading && propertyDetails) {
        ...
        const { title, costPerNight, property_type, room_type, detailsAddress, basics, facilities, standoutAmenities, safetyItems, thumbnail, extraImages } = propertyDetails?.data || {}
        const images = {
        ...
        content = <div className="max-width">
            <div className="">
                <div className="mt-10">
                ...
                <div className="mt-10 w-full">
                    <img src={activeImg ? activeImg : `http://localhost:8000/uploaded-images/${thumbnail}`} className="h-[500px] w-full rounded-md" alt="" />
                    <div className="flex  gap-x-6 mt-5 w-[60%]">
                        <img onClick={() => setActiveImage(images.img1)} src={images.img1} className="h-[80px] w-[150px]  cursor-pointer rounded-sm" alt="" />
                        <img onClick={() => setActiveImage(images.img2)} src={images.img2} className="h-[80px] w-[150px]  cursor-pointer rounded-sm" alt="" />
                        <img onClick={() => setActiveImage(images.img3)} src={images.img3} className="h-[80px] w-[150px]  cursor-pointer rounded-sm" alt="" />
            ...
            <div className="flex justify-between mt-10">
                <div>
                    <h1 className="text-2xl uppercase font-semibold">{title} - hosted by <span className="text-bl cursor-pointer">Mohsin reza</span>
                    </h1>
                    <h1 className="py-2 text-gr">Budget per night <span className="text-bl ms-4">{costPerNight ? costPerNight.toFixed(2) : 0.00} Taka</span></h1>
            ...
            <div className="flex-between items-start">
                <div className="w-3/5">
                    <div className="mb-10">
                        ...
                        <p className="text-gr">{description ? description : <span className="block py-4 text-red-500">Nothing special written</span>}</p>
                    </div>
                        ...
                        <div className="flex flex-col gap-y-4 mt-4">
                            ...
                            <div className="flex gap-x-4 items-center ">
                                ...
                                <div className='flex gap-x-6'>
                                    ...
                                    {facilities.map((item, index) => <div key={index} className={`px-5 py-1 shadow-md rounded-md bg-gray-300 border-2 border-gray-400 `}>
                            ...
                            <div className="flex gap-x-4 items-center ">
                                ...
                                <div className='flex gap-x-6'>
                                    ...
                                    {safetyItems.map((item, index) => <div key={index} className={`px-5 py-1 shadow-md rounded-md bg-gray-300 border-2 border-gray-400 `}>
                                        <p className="text-xs">{item}</p>
                                    </div>)}
                            ...
                            <div className="flex gap-x-4 items-center ">
                                ...
                                <div className='flex gap-x-6'>
                                    ...
                                    {standoutAmenities.map((item, index) => <div key={index} className={`px-5 py-1 shadow-md rounded-md bg-gray-300 border-2 border-gray-400 `}>
                                        <p className="text-xs">{item}</p>
                                    </div>)}
                    ...
                    <div className="mt-6">
                        ...
                        {reviews ? <div>
                            <div className="flex items-center gap-x-2">
                                ...
                                <h1 className="text-bl my-2">5.0  <span className="ms-2">204 reviews</span></h1>
                            </div>
                    ...
                    <div className='px-10'>
                        ...
                        <div className="shadow-md px-2">
                            <div className='flex flex-col  gap-6 mt-10 '>
                                ...
                                <div className="flex gap-x-6">
                                    <div className="w-50 me-2">
                                        ...
                                        <select className='text-black w-[200px] py-2 rounded-md font-bold  text-center' name="" id="">
                                ...
                                <div>
                                    ...
                                    <select className='text-black w-[200px] py-2 rounded-md font-bold ' name="" id="">
                            ...
                            <div className='bg-white p-3 rounded-full mt-6 cursor-pointer w-full'>
                                <Link to="/book-now"><button className="primary-btn w-full rounded-md">Book Now</button></Link>
                            </div>
                        </div>
