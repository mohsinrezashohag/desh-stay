...
const SearchResult = () => {
  ...
  console.log('searchInfo at search page : ', searchInfo)
  ...
  filteredProperties = properties?.filter((property) =>
    property?.detailsAddress?.city
      .toLowerCase()
      .includes(searchInfo?.destination.toLowerCase())
  )
      ...
      <div className='max-width'>
        ...
        <div className='flex mt-10'>
          <div className='flex-initial w-96 '>
            <div
              className='flex flex-col gap-3 mt-10 text-white bg-[#01257D] px-10 py-6 rounded-xl'
              style={{ height: '500px' }}
            >
              <div className=''>
                <h1 className='capitalize py-2 '>Select Destination</h1>
                <select
                  className='text-black w-[250px] py-2 rounded-full font-bold  text-center'
                  name=''
                  id=''
                >
          ...
          <div className='flex-initial w-full ps-10'>
            <div className='flex-between'>
              <h1 className='capitalize text-3xl font-bold'>
                {searchInfo &&
                  `${searchInfo?.destination} - ${filteredProperties?.length} Properties found`}
              </h1>

              <select
                className='px-10 py-2 border-spacing-2'
                  ...
                  <div className='flex items-start gap-6 shadow-md rounded-md p-3 mt-6'>
                    ...
                    <div className='flex justify-between'>
                      <div>
                        ...
                        <div className='flex gap-6 mt-3'>
                          <div className='flex gap-2 items-center'>
                            ...
                            <p>
                              {item?.basics.guestLimit}
                              <span className='mx-2'>Persons</span>
                            </p>
                          </div>
                          <div className='flex gap-2 items-center '>
                      ...
                      <div className='ps-80'>
                        ...
                        <Link to={`/apartment-details/${item?._id}`}>
