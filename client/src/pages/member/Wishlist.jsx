...
import { useGetMyWishlistQuery } from '../../rtk/features/wishlist/wishlistApi';
...
const Wishlist = () => {
    ...
    // rtk queries
    const { data: myWishlist, isLoading, isError } = useGetMyWishlistQuery(user?._id)
    ...
    if (!isLoading && !isError && myWishlist.data) {
        content = <div>
            {myWishlist.data.map((item, index) => {
                <div key={index} className="flex items-start gap-6 shadow-md rounded-md p-3 mt-6">
    ...
    return (
        <>
            ...
            <div className='max-width'>
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div className="flex items-center">
                                ...
                                <Link to="/your-trips" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">wishlist</Link>
                            </div>
                        </li>
                    </ol>
                </div>
                ...
                <div className='pb-32'>
                    <h1 className='text-3xl uppercase font-bold text-bl text-center py-20'>Your wishlist</h1>
