  ...
  return (
    <>
      ...
      <div className='max-width'>
        ...
        <div>
          <h1 className='text-3xl uppercase text-bl font-semibold pt-20 pb-5'>
            List your property
          </h1>
            ...
            <form action='#' className='w-[50%]'>
              ...
              <div className='grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5'>
                <div className='sm:col-span-2 mt-4'>
                  <h1 className='text-1xl uppercase text-bl font-semibold pt-10 pb-5'>
                    {' '}
                    Set Apartment Price (Per Night)
                  </h1>
                  <input
                    onChange={(e) =>
                      setProperty({ ...property, costPerNight: e.target.value })
                    }
                    type='number'
                    name='price'
                    id='price'
          ...
          <div>
            ...
            <div className='flex gap-x-6'>
              ...
              <div
                onClick={() => setPropertyType('Eco')}
                className={`flex gap-x-3 items-center  px-10 py-3 shadow-md rounded-md cursor-pointer border-2 border-gray-400 ${
                  property.property_type === 'Eco'
                    ? 'bg-[#01257D] text-white'
                    : ''
                }`}
              >
        ...
        <div>
          ...
          <div className='flex gap-x-6'>
            <div
              ...
              className={`flex gap-x-3 items-center  px-10 py-3 shadow-md rounded-md cursor-pointer border-2 border-gray-400 ${
                property.room_type === 'Entire place'
                  ? 'bg-[#01257D] text-white'
                  : ''
              }`}
            >
            ...
            <div
              ...
              className={`flex gap-x-3 items-center  px-10 py-3 shadow-md rounded-md cursor-pointer border-2 border-gray-400 ${
                property.room_type === 'Private Room'
                  ? 'bg-[#01257D] text-white'
                  : ''
              }`}
            >
            ...
            <div
              ...
              className={`flex gap-x-3 items-center  px-10 py-3 shadow-md rounded-md cursor-pointer border-2 border-gray-400 ${
                property.room_type === 'Shared Room'
                  ? 'bg-[#01257D] text-white'
                  : ''
              }`}
            >
        ...
        <div className='w-[60%] mb-20'>
          <h1 className='text-1xl uppercase text-bl font-semibold pt-20 '>
            Details Address
          </h1>
          <p className='text-gr'>
            Note: your detail address is only shared with guest only when the
          ...
          <div className='w-50'>
            ...
            <Link to='/list-property-second-step'>
              <button
                onClick={handleNextStep}
                className='primary-btn w-40 rounded-md'
              >
                Next Step
              </button>
            </Link>
